function [FW_ANALYSIS] = analyse_feature_weights_erp_conn(ANALYSIS)
%
...
FW_ANALYSIS.chaninfo = conn_chaninfo;
FW_ANALYSIS.chanlocs = conn_chanlocs;

display_feature_weights_results_conn(ANALYSIS, FW_ANALYSIS);
