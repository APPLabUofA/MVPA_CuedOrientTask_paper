...
%            ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
% 
% -> byCues_ML_v1: Epoched to cues; postocularthresh = [-500 500]. 
%    Epoch limit [-1.2 2.2]. ERP baseline NaN. Filter on [0.1 50]. Freq 
%    range [1 40]. Timesout = 300. Padratio = 4. 
%    Rejected trials w/horizontal eye movements, thresh = 25, timewin = 
%    timewin = [-200 1950], winSize = 100, winStep = 10
%    No visual inspection to reject trials.
% 
%            ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
% 
% -> byTargets_ML_v1: Epoched to targets; postocularthresh = [-500 500]. 
%    Epoch limit [-2.4 1.4]. exp.epochbaseline = [];. Filter on [0.1 50]. 
%    Freq range [1 40]. Timesout = 300. Padratio = 4. 
%    Rejected trials w/horizontal eye movements, thresh = 25, timewin = 
%    [-1600 600], winSize = 100, winStep = 10
%    Performed visual inspection to reject trials:
%           reject_trials_inspect_Exo_ML.m
% 
%            ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
% 
...
% exp.setname = {'byTargets_ML_v1'}; % name each epoched set
exp.setname = {'byCues_ML_v1'}; % name each epoched set
...
% exp.participants = {'004';'005';'006';'007';'008';'009';'010';'011';'012';...
%     '013';'014';'015';'017';'018';'019';'021';'022';'023';'024';'025';'026';...
...
%     '013';'014';'015';'017';'018';'019';'021';'022';'024';'025';'026';...
%     '027';'029';'031';'032';'034';'035';'036';'037';'038';...
%     '039';'040'};
...
exp.participants = {'004';'005';'007';'009';'010';...
    '012';'013';'014';'015';'017';'018';'019';'021';'022';'024';...
    '025';'026';'027';'029';'031';'032';'034';'035';...
    '036';'037';'038';'039';'040'};
...
tic %start timer
Preproc_OrientWheel_Exo_ML(exp)
toc %end timer
